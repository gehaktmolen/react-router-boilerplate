		...
		var content = [
						  {
						    ...
						    "page": {
						      ...
						      "home": {
						        ...
						        "text": "This is a very basic example how to create multilingual React website using Flux. You can take this code as a base and build on it, replacing current content retrieval from JSON with calls to APIs, extending functionality, etc.",
						        "goUp": "Go up"
						      },
						      "about": {
